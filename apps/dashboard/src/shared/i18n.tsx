...
export const ZH_TEXT = {
  ...
  tools: {
    ...
    overviewEyebrow: "Agent 能力",
    overviewTitle: "工具目录",
    overviewDescription: "按工具集浏览当前 Agent 可以调用的原子能力。",
    toolsets: "工具集",
    totalTools: "工具总数",
    totalParameters: "参数总数",
  ...
  skills: {
    ...
    overviewEyebrow: "工作流能力",
    overviewTitle: "技能目录",
    overviewDescription: "按业务类型浏览可复用、可组合的 Agent 工作流。",
    totalSkills: "技能总数",
    groups: "技能分类",
    totalCommands: "关联命令",
...
export const UI_TEXT: Record<Language, UiText> = {
  ...
  en: {
    ...
    tools: {
      ...
      overviewEyebrow: "Agent capabilities",
      overviewTitle: "Tool catalog",
      overviewDescription: "Browse the atomic capabilities this agent can call, organized by toolset.",
      toolsets: "Toolsets",
    ...
    skills: {
      ...
      overviewEyebrow: "Workflow capabilities",
      overviewTitle: "Skill catalog",
      overviewDescription: "Browse reusable and composable agent workflows by business area.",
