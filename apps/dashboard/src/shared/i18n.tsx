...
export const ZH_TEXT = {
  ...
  userQuestions: {waiting:"等待回答",received:"回答已接收",submit:"提交回答",submitting:"正在提交…",stop:"停止本次任务",stopping:"正在停止…",pagination:"问题分页",previous:"上一题",next:"下一题",multiple:"可多选，也可以补充文字",custom:"自己的回答",customPlaceholder:"填写自己的回答…",freeText:"回答"},
  language: {
    label: "语言",
    zh: "中文",
    en: "EN"
