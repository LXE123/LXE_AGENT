...
requireText("packages/foundation/desktop-protocol/src/index.ts", /AGENT_PROTOCOL_VERSION\s*=\s*11\s+as const/, "agent protocol must use the conversation-phase v11 contract");
