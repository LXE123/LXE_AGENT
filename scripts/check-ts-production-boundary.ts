...
requireText("packages/foundation/desktop-protocol/src/index.ts", /AGENT_PROTOCOL_VERSION\s*=\s*19\s+as const/, "agent protocol must use the JSON-RPC v19 business contract");
