...
requireText("packages/foundation/desktop-protocol/src/index.ts", /AGENT_PROTOCOL_VERSION\s*=\s*20\s+as const/, "agent protocol must use the JSON-RPC v20 business contract");
