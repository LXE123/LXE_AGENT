...
requireText("packages/foundation/desktop-protocol/src/index.ts", /AGENT_PROTOCOL_VERSION\s*=\s*10\s+as const/, "agent protocol must use the attachment-resolution v10 contract");
