...
requireText("packages/foundation/desktop-protocol/src/index.ts", /AGENT_PROTOCOL_VERSION\s*=\s*12\s+as const/, "agent protocol must use the ordered-turn-parts v12 contract");
