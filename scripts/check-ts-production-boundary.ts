...
requireText("packages/foundation/desktop-protocol/src/index.ts", /AGENT_PROTOCOL_VERSION\s*=\s*13\s+as const/, "agent protocol must use the desktop-part-delta v13 contract");
