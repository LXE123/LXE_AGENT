...
requireText("packages/foundation/desktop-protocol/src/index.ts", /AGENT_PROTOCOL_VERSION\s*=\s*15\s+as const/, "agent protocol must use the managed-credential v15 contract");
