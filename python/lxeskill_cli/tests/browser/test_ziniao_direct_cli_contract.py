...
def test_unverified_ziniao_cli_session_wrapper_is_not_present() -> None:
    removed_paths = [
        "python/lxeskill_cli/services/browser/store/ziniao_cli_client.py",
        "python/lxeskill_cli/tests/test_ziniao_cli_client.py",
        "python/lxeskill_cli/tests/test_ziniao_store_session_cli_backend.py",
    ]
...
def test_store_session_service_does_not_depend_on_ziniao_cli_backend() -> None:
    text = _repo_text("python/lxeskill_cli/services/browser/store/store_session_service.py")
...
def test_ziniao_config_only_controls_legacy_planner_tool_visibility() -> None:
    text = _repo_text("python/lxeskill_cli/services/browser/store/ziniao_config.py")
